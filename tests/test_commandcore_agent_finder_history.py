from cfh_disposition.commandcore_agent_finder_ui import (
    _linked_deal_id,
    _linked_property_context,
    _research_activity,
)
...
def test_agent_finder_uses_linked_deal_context_and_writes_safe_history() -> None:
    ...
    deal_id = _linked_deal_id("contact-1", deals)
    address, city, state, listing_url = _linked_property_context("contact-1", deals, properties)
