...
_REQUIREMENTS: dict[str, tuple[bool, str, str, str, bool, bool]] = {
    ...
    "meta_ads": (
        False,
        "Planning software complete — paid platform setup and owner approval required",
        "Complete Meta account/campaign setup and obtain owner approval for the exact targeting and spend",
        "Paid setup required",
        True,
        False,
    ),
    "google_ads": (
        False,
        "Planning software complete — paid platform setup and owner approval required",
        "Complete Google Ads account/campaign setup and obtain owner approval for the exact targeting and spend",
        "Paid setup required",
        True,
        False,
    ),
    "instagram": (
        True,
        "Assisted social workflow complete — optional publish adapter",
        "Use the approved manual final post now, or connect SOCIAL_PUBLISH_WEBHOOK_URL for optional handoff",
        "Approval-controlled assisted publish",
        False,
        True,
    ),
    "tiktok": (
    ...
    "chatgpt_ads": (
        False,
        "Planning software complete — Ads Manager setup and owner approval required",
        "Set up the current OpenAI Ads Manager account/billing and conversion measurement, then obtain owner approval for the exact buyer-acquisition campaign and spend",
