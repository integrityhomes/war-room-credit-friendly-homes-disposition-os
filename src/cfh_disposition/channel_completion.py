...
_REQUIREMENTS: dict[str, tuple[bool, str, str, str, bool, bool]] = {
    ...
    "blog": (
        False,
        "Software complete — publishing connection required",
        "Approve content and connect final publishing workflow",
        "Approval required",
        True,
        False,
    ),
    "market_seo": (
        False,
        "Software complete — publishing connection required",
        "Connect final publishing workflow for live SEO pages",
        "Automatic / owned web",
        True,
        False,
    ),
