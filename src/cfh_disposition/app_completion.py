...
APP_COMPLETION: tuple[AppCompletion, ...] = (
    ...
    AppCompletion(
        ...
        "Marketing & Dispo",
        AppCompletionState.EXTERNAL_BLOCKER,
        "Canonical buyer-reactivation app; older duplicate removed.",
        "Live dispatch requires the approved buyer-outreach webhook connection.",
    ),
    AppCompletion(
        "pages/14_AI_Creative_Winner_Rotation.py",
        "Marketing & Dispo",
        AppCompletionState.COMPLETE,
        "Creative-testing app limits new tests to Ready-to-Launch/Marketing-Live properties.",
    ),
    AppCompletion(
    ...
    AppCompletion(
        ...
        "Marketing & Dispo",
        AppCompletionState.EXTERNAL_BLOCKER,
        "Signed Dwelyx result attribution software and receiver are built.",
    ...
    AppCompletion(
        ...
        "Marketing & Dispo",
        AppCompletionState.EXTERNAL_BLOCKER,
        "Canonical social-video package/publish-handoff app; duplicate removed.",
        "Live platform publication requires an approved social publishing adapter/account connection.",
    ),
    ...
    AppCompletion(
        ...
        "Marketing & Dispo",
        AppCompletionState.EXTERNAL_BLOCKER,
        "Paid-traffic package software is complete and approval-gated.",
        "Live Meta/Google campaigns require account authorization and explicit spending approval.",
    ),
    AppCompletion(
        "pages/29_Email_SMS_Reactivation.py",
        "Marketing & Dispo",
        AppCompletionState.EXTERNAL_BLOCKER,
        "Email/SMS software handoffs are built with consent/DNC guards.",
        "Live sender endpoints/accounts must be connected.",
    ),
    ...
    AppCompletion(
        ...
        "Marketing & Dispo",
        AppCompletionState.EXTERNAL_BLOCKER,
        "ChatGPT Ads package/connection path is software-complete.",
        "Live use requires supported account/platform connection and any required spend approval.",
    ),
    ...
    AppCompletion(
        ...
        "Management",
        AppCompletionState.EXTERNAL_BLOCKER,
        "Safe migration preview/apply/reconciliation UI is built.",
        "CRM cutover remains blocked until real source-CRM reconciliation is verified.",
    ),
